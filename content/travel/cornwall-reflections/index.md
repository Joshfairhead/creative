...
title = "Cornwall Reflections"
description = "Pattern integrity, energetic transformation, and the cosmic significance of Eden"
date = 2026-05-22
draft = false
...
{{ image(url="potencies-pattern.png", alt="Potencies Pattern", no_hover=true) }}

{{ image(url="energetic-pattern.png", alt="Energetic Pattern", no_hover=true) }}
...
{{ image(url="existential-pattern.png", alt="Existential Pattern", no_hover=true) }}
...
{{ image(url="vital-cosmos-pattern.png", alt="Vital Cosmos Pattern", no_hover=true) }}
